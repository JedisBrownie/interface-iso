            ...
            <div className="paper-three">
                <div className="entete" contentEditable='false'>
                    ...
                    <div className='titre' contentEditable="false" style={{textAlign:'center'}}>
                        <div className="div-content-editable" role="textbox" ref={references.champTitre}  suppressContentEditableWarning={true} contentEditable="false" style={{textAlign:'center',color:'red',height:'fit-content'}}></div>
                ...
                <div className='commentaire' contentEditable='false' >
                    ...
                    <div className='commentaire-row' contentEditable="false">
                        <div className='div-content-editable valeur-champ' role="textbox" ref={references.champFaitQuoiCommentaire} contentEditable={edition} style={{lineHeight:'18px'}} >

                        </div>
                        <div className='div-content-editable valeur-champ' role="textbox" ref={references.champLienMoyenCommentaire} contentEditable={edition}>
