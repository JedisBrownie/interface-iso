...
export default function Brouillon(){
    ...
    [
        {idMatricule : 4580 , nom : 'Aina Razafindrakoto' , listeDocument : [
            {id:1,referenceDocument:'BR200-20240501-2',nomStatus:'Brouillon',status:'Brouillon',dateCreation: '17/01/2024',idTypeDocument:1 ,nomTypeDocument : 'Processus',nom:"Inventaire physique des stocks de ciments , sacs vides et palettes organisé par la DAF",nombreRevision:0,listeProcessusLie:[],modification:false},
